...
monthly = df_2025.groupby('month')['hours_played'].sum().sort_index()
...
ax.set_title("Adi's Music Journey in 2025", fontsize=18, fontweight='bold', pad=20)
...
plt.tight_layout()
plt.savefig('visualizations/monthly_trends_2025.png', dpi=300, bbox_inches='tight', facecolor='white')
plt.close()
